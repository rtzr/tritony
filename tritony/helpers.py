...
def get_triton_client(flag: TritonClientFlag):
    """
    (required in)
    :param flag:
    - protocol
    ...
    :return:
    """
    triton_client = init_triton_client(flag)
    ...
    return triton_client, max_batch_size, input_name_list, output_name_list, dtype_list
